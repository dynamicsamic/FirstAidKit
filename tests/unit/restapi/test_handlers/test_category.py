...
@patch.object(CategoryService, "list_items", return_value=categories)
...
@patch.object(CategoryService, "list_items", return_value=[])
...
@patch.object(CategoryService, "list_items")
