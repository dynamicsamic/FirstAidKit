...
now = now_()
category = Category(pk=1, name="test1", created_at=now, updated_at=now)
...
class TestCategoryHandlers:
    list_create_url = "/api/v1/categories"
    ...
    async def test_get_category_with_existing_id_return_category_instance(
        ...
        category_id = 1
        resp = await test_client.get(f"{self.list_create_url}/{category_id}")
    ...
    async def test_update_category_with_valid_partial_data_return_category_instance(
        ...
        resp = await test_client.patch(
            f"{self.list_create_url}/{category_id}", json=payload
        )
    ...
    async def test_delete_category_with_existing_id_return_204_status(
        ...
        category_id = 1
        resp = await test_client.delete(f"{self.list_create_url}/{category_id}")
